...
raytracing.receiver_list = list_of_receivers_creation(raytracing, 200, 110, 10)

# RAYTRACING
raytracing.ray_power_distribution((199.005, 53.00909090909091), 0, "mean")
